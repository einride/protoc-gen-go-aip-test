...
| invalid user settable id - uuid | Method should fail with InvalidArgument if the user settable ID appears to be a UUID, see [doc](https://google.aip.dev/122#resource-id-segments).        | <ul><li>Create method does not return long-running operation</li><li>has Create method</li><li>has user settable ID</li></ul>    |
