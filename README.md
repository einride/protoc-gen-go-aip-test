...
| etag is updated      | Field etag should have a new value when the resource is successfully updated.                               | Generated only if all are true: <ul><li>has Update method</li><li>request has etag field</li><li>has field 'etag'</li></ul>                                                                                                                             |
...
| current etag supplied | Deletion with the current etag supplied should succeed.                                                   | Generated only if all are true: <ul><li>has Delete method</li><li>request has etag field</li><li>has field 'etag'</li></ul> |
