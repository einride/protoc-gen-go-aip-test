...
| user settable id    | The created resource should be returned with the ID supplied by the user.                                      | Generated only if all are true: <ul><li>has Create method</li><li>Create method does not return long-running operation</li></ul>                                 |
