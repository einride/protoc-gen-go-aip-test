...
func (fx *IndexTestSuiteConfig) test(t *testing.T) {
...
func (fx *IndexTestSuiteConfig) testCreate(t *testing.T) {
	fx.maybeSkip(t)
...
func (fx *IndexTestSuiteConfig) testGet(t *testing.T) {
	fx.maybeSkip(t)
...
func (fx *IndexTestSuiteConfig) testUpdate(t *testing.T) {
	fx.maybeSkip(t)
	// Method should fail with InvalidArgument if no name is provided.
	t.Run("missing name", func(t *testing.T) {
		fx.maybeSkip(t)
...
func (fx *IndexTestSuiteConfig) testDelete(t *testing.T) {
	fx.maybeSkip(t)
	// Method should fail with InvalidArgument if no name is provided.
	t.Run("missing name", func(t *testing.T) {
		fx.maybeSkip(t)
...
func (fx *IndexTestSuiteConfig) nextParent(t *testing.T, pristine bool) string {
	if pristine {
		fx.currParent++
	}
...
func (fx *IndexTestSuiteConfig) peekNextParent(t *testing.T) string {
...
func (fx *IndexTestSuiteConfig) maybeSkip(t *testing.T) {
...
func (fx *IndexTestSuiteConfig) create(t *testing.T, parent string) *Index {
	t.Helper()
