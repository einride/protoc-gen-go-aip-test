...
func (fx *PipelineServicePipelineJobTestSuiteConfig) testList(t *testing.T) {
	...
	}
	{
		...
		t.Run("page size zero", func(t *testing.T) {
			...
			var nextPageToken string
			for {
				page, err := fx.Service().ListPipelineJobs(fx.Context(), &ListPipelineJobsRequest{
					Parent:    parent,
					PageSize:  0,
					PageToken: nextPageToken,
				})
...
func (fx *PipelineServiceTrainingPipelineTestSuiteConfig) testList(t *testing.T) {
	...
	}
	{
		...
		t.Run("page size zero", func(t *testing.T) {
			...
			var nextPageToken string
			for {
				page, err := fx.Service().ListTrainingPipelines(fx.Context(), &ListTrainingPipelinesRequest{
					Parent:    parent,
					PageSize:  0,
					PageToken: nextPageToken,
				})
