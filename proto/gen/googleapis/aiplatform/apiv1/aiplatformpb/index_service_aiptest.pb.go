...
func (fx *IndexServiceIndexTestSuiteConfig) clone() *IndexServiceIndexTestSuiteConfig {
	clone := *fx
	return &clone
}
...
func (fx *IndexServiceIndexTestSuiteConfig) testList(t *testing.T) {
...

	{
		...
		t.Run("page size zero", func(t *testing.T) {
			...
			assert.Check(t, len(response.Indexes) > 0, "expected server to return at least 1 resource with page_size=0")
		})
