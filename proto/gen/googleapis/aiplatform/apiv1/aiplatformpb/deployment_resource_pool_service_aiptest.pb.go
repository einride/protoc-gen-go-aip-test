...
func (fx *DeploymentResourcePoolServiceDeploymentResourcePoolTestSuiteConfig) clone() *DeploymentResourcePoolServiceDeploymentResourcePoolTestSuiteConfig {
	clone := *fx
	return &clone
}
...
func (fx *DeploymentResourcePoolServiceDeploymentResourcePoolTestSuiteConfig) testList(t *testing.T) {
...

	{
		...
		t.Run("page size zero", func(t *testing.T) {
			...
			assert.Check(t, len(response.DeploymentResourcePools) > 0, "expected server to return at least 1 resource with page_size=0")
		})
