...
type InstanceConfigTestSuiteConfig struct {
	...
	// provided the test will fail.
	Parents []string
	// CreateResource should create a InstanceConfig and return it.
	...
	CreateResource func(ctx context.Context, parent string) (*InstanceConfig, error)
	// Patterns of tests to skip.
	// For example if a service has a Get method:
	// Skip: ["Get"] will skip all tests for Get.
	// Skip: ["Get/persisted"] will only skip the subtest called "persisted" of Get.
...
func (fx *InstanceConfigTestSuiteConfig) create(t *testing.T, parent string) *InstanceConfig {
	...
	if fx.CreateResource == nil {
		t.Skip("Test skipped because CreateResource not specified on InstanceConfigTestSuiteConfig")
	}
