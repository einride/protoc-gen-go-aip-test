...
func (fx *DatabaseAdminBackupTestSuiteConfig) testList(t *testing.T) {
...

	{
		...
		t.Run("page size zero", func(t *testing.T) {
			...
			assert.Check(t, len(response.GetBackups()) > 0, "expected server to return at least 1 resource with page_size=0")
		})
...
func (fx *DatabaseAdminDatabaseTestSuiteConfig) testList(t *testing.T) {
...

	{
		...
		t.Run("page size zero", func(t *testing.T) {
			...
			assert.NilError(t, err)
			// Server should use a default page size and return at least some results
			assert.Check(t, len(response.GetDatabases()) > 0, "expected server to return at least 1 resource with page_size=0")
		})
...
func (fx *DatabaseAdminDatabaseRoleTestSuiteConfig) testList(t *testing.T) {
...

	{
		...
		t.Run("page size zero", func(t *testing.T) {
			...
			assert.NilError(t, err)
			// Server should use a default page size and return at least some results
			assert.Check(t, len(response.GetDatabaseRoles()) > 0, "expected server to return at least 1 resource with page_size=0")
		})
