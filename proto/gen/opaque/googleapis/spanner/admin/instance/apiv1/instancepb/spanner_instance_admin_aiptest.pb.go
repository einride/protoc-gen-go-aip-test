	...
	}
	{
		...
		t.Run("page size zero", func(t *testing.T) {
			...
			for {
				...
				req.SetPageSize(0)
				req.SetPageToken(nextPageToken)
				page, err := fx.Service().ListInstances(fx.Context(), req)
				assert.NilError(t, err)
				msgs = append(msgs, page.GetInstances()...)
	...
	}
	{
		...
		t.Run("page size zero", func(t *testing.T) {
			...
			for {
				...
				req.SetPageSize(0)
				req.SetPageToken(nextPageToken)
				page, err := fx.Service().ListInstanceConfigs(fx.Context(), req)
				assert.NilError(t, err)
				msgs = append(msgs, page.GetInstanceConfigs()...)
				nextPageToken = page.GetNextPageToken()
				if nextPageToken == "" {
					break
				}
	...
	}
	{
		...
		t.Run("page size zero", func(t *testing.T) {
			...
			for {
				...
				req.SetPageSize(0)
				req.SetPageToken(nextPageToken)
				page, err := fx.Service().ListInstancePartitions(fx.Context(), req)
				assert.NilError(t, err)
				msgs = append(msgs, page.GetInstancePartitions()...)
				nextPageToken = page.GetNextPageToken()
				if nextPageToken == "" {
					break
				}
