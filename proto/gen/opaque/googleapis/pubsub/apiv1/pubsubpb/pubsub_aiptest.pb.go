...
func (fx *PublisherTopicTestSuiteConfig) testUpdate(t *testing.T) {
	...
	t.Run("missing name", func(t *testing.T) {
		...
		req.SetTopic(msg)
		_, err := fx.Service().UpdateTopic(fx.Context(), req)
...
func (fx *SubscriberSnapshotTestSuiteConfig) testUpdate(t *testing.T) {
	...
	t.Run("missing name", func(t *testing.T) {
		...
		req.SetSnapshot(msg)
		_, err := fx.Service().UpdateSnapshot(fx.Context(), req)
		assert.Equal(t, codes.InvalidArgument, status.Code(err), err)
	})
...
func (fx *SubscriberSubscriptionTestSuiteConfig) testUpdate(t *testing.T) {
	...
	t.Run("missing name", func(t *testing.T) {
		...
		req.SetSubscription(msg)
		_, err := fx.Service().UpdateSubscription(fx.Context(), req)
		assert.Equal(t, codes.InvalidArgument, status.Code(err), err)
	})
