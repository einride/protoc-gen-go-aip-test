...
func (fx *TensorboardServiceTensorboardTestSuiteConfig) testList(t *testing.T) {
...

	{
		...
		t.Run("page size zero", func(t *testing.T) {
			...
			assert.Check(t, len(response.GetTensorboards()) > 0, "expected server to return at least 1 resource with page_size=0")
		})
...
func (fx *TensorboardServiceTensorboardExperimentTestSuiteConfig) testList(t *testing.T) {
...

	{
		...
		t.Run("page size zero", func(t *testing.T) {
			...
			assert.NilError(t, err)
			// Server should use a default page size and return at least some results
			assert.Check(t, len(response.GetTensorboardExperiments()) > 0, "expected server to return at least 1 resource with page_size=0")
		})
...
func (fx *TensorboardServiceTensorboardRunTestSuiteConfig) testList(t *testing.T) {
...

	{
		...
		t.Run("page size zero", func(t *testing.T) {
			...
			assert.NilError(t, err)
			// Server should use a default page size and return at least some results
			assert.Check(t, len(response.GetTensorboardRuns()) > 0, "expected server to return at least 1 resource with page_size=0")
		})
...
func (fx *TensorboardServiceTensorboardTimeSeriesTestSuiteConfig) testList(t *testing.T) {
...

	{
		...
		t.Run("page size zero", func(t *testing.T) {
			...
			assert.NilError(t, err)
			// Server should use a default page size and return at least some results
			assert.Check(t, len(response.GetTensorboardTimeSeries()) > 0, "expected server to return at least 1 resource with page_size=0")
		})
