...
func (fx *ModelGardenServicePublisherModelTestSuiteConfig) testGet(t *testing.T) {
	...
	t.Run("missing name", func(t *testing.T) {
		fx.maybeSkip(t)
		req := &GetPublisherModelRequest{}
		req.SetName("")
		_, err := fx.Service().GetPublisherModel(fx.Context(), req)
	...
	t.Run("exists", func(t *testing.T) {
		...
		msg, err := fx.Service().GetPublisherModel(fx.Context(), req)
