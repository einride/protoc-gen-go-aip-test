	...
	}
	{
		...
		t.Run("page size zero", func(t *testing.T) {
			...
			for {
				...
				req.SetPageSize(0)
				req.SetPageToken(nextPageToken)
				page, err := fx.Service().ListArtifacts(fx.Context(), req)
				assert.NilError(t, err)
				msgs = append(msgs, page.GetArtifacts()...)
	...
	}
	{
		...
		t.Run("page size zero", func(t *testing.T) {
			...
			for {
				...
				req.SetPageSize(0)
				req.SetPageToken(nextPageToken)
				page, err := fx.Service().ListContexts(fx.Context(), req)
				assert.NilError(t, err)
				msgs = append(msgs, page.GetContexts()...)
				nextPageToken = page.GetNextPageToken()
				if nextPageToken == "" {
					break
				}
	...
	}
	{
		...
		t.Run("page size zero", func(t *testing.T) {
			...
			for {
				...
				req.SetPageSize(0)
				req.SetPageToken(nextPageToken)
				page, err := fx.Service().ListExecutions(fx.Context(), req)
				assert.NilError(t, err)
				msgs = append(msgs, page.GetExecutions()...)
				nextPageToken = page.GetNextPageToken()
				if nextPageToken == "" {
					break
				}
	...
	}
	{
		...
		t.Run("page size zero", func(t *testing.T) {
			...
			for {
				...
				req.SetPageSize(0)
				req.SetPageToken(nextPageToken)
				page, err := fx.Service().ListMetadataSchemas(fx.Context(), req)
				assert.NilError(t, err)
				msgs = append(msgs, page.GetMetadataSchemas()...)
				nextPageToken = page.GetNextPageToken()
				if nextPageToken == "" {
					break
				}
	...
	}
	{
		...
		t.Run("page size zero", func(t *testing.T) {
			...
			for {
				...
				req.SetPageSize(0)
				req.SetPageToken(nextPageToken)
				page, err := fx.Service().ListMetadataStores(fx.Context(), req)
				assert.NilError(t, err)
				msgs = append(msgs, page.GetMetadataStores()...)
				nextPageToken = page.GetNextPageToken()
				if nextPageToken == "" {
					break
				}
