	...
	}
	{
		...
		t.Run("page size zero", func(t *testing.T) {
			...
			for {
				...
				req.SetPageSize(0)
				req.SetPageToken(nextPageToken)
				page, err := fx.Service().ListAnnotations(fx.Context(), req)
				assert.NilError(t, err)
				msgs = append(msgs, page.GetAnnotations()...)
	...
	}
	{
		...
		t.Run("page size zero", func(t *testing.T) {
			...
			for {
				...
				req.SetPageSize(0)
				req.SetPageToken(nextPageToken)
				page, err := fx.Service().ListDataItems(fx.Context(), req)
				assert.NilError(t, err)
				msgs = append(msgs, page.GetDataItems()...)
				nextPageToken = page.GetNextPageToken()
				if nextPageToken == "" {
					break
				}
	...
	}
	{
		...
		t.Run("page size zero", func(t *testing.T) {
			...
			for {
				...
				req.SetPageSize(0)
				req.SetPageToken(nextPageToken)
				page, err := fx.Service().ListDatasets(fx.Context(), req)
				assert.NilError(t, err)
				msgs = append(msgs, page.GetDatasets()...)
				nextPageToken = page.GetNextPageToken()
				if nextPageToken == "" {
					break
				}
	...
	}
	{
		...
		t.Run("page size zero", func(t *testing.T) {
			...
			for {
				...
				req.SetPageSize(0)
				req.SetPageToken(nextPageToken)
				page, err := fx.Service().ListDatasetVersions(fx.Context(), req)
				assert.NilError(t, err)
				msgs = append(msgs, page.GetDatasetVersions()...)
				nextPageToken = page.GetNextPageToken()
				if nextPageToken == "" {
					break
				}
	...
	}
	{
		...
		t.Run("page size zero", func(t *testing.T) {
			...
			for {
				...
				req.SetPageSize(0)
				req.SetPageToken(nextPageToken)
				page, err := fx.Service().ListSavedQueries(fx.Context(), req)
				assert.NilError(t, err)
				msgs = append(msgs, page.GetSavedQueries()...)
				nextPageToken = page.GetNextPageToken()
				if nextPageToken == "" {
					break
				}
