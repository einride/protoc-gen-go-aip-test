	...
	}
	{
		...
		t.Run("page size zero", func(t *testing.T) {
			...
			for {
				...
				req.SetPageSize(0)
				req.SetPageToken(nextPageToken)
				page, err := fx.Service().ListBatchPredictionJobs(fx.Context(), req)
				assert.NilError(t, err)
				msgs = append(msgs, page.GetBatchPredictionJobs()...)
	...
	}
	{
		...
		t.Run("page size zero", func(t *testing.T) {
			...
			for {
				...
				req.SetPageSize(0)
				req.SetPageToken(nextPageToken)
				page, err := fx.Service().ListCustomJobs(fx.Context(), req)
				assert.NilError(t, err)
				msgs = append(msgs, page.GetCustomJobs()...)
				nextPageToken = page.GetNextPageToken()
				if nextPageToken == "" {
					break
				}
	...
	}
	{
		...
		t.Run("page size zero", func(t *testing.T) {
			...
			for {
				...
				req.SetPageSize(0)
				req.SetPageToken(nextPageToken)
				page, err := fx.Service().ListDataLabelingJobs(fx.Context(), req)
				assert.NilError(t, err)
				msgs = append(msgs, page.GetDataLabelingJobs()...)
				nextPageToken = page.GetNextPageToken()
				if nextPageToken == "" {
					break
				}
	...
	}
	{
		...
		t.Run("page size zero", func(t *testing.T) {
			...
			for {
				...
				req.SetPageSize(0)
				req.SetPageToken(nextPageToken)
				page, err := fx.Service().ListHyperparameterTuningJobs(fx.Context(), req)
				assert.NilError(t, err)
				msgs = append(msgs, page.GetHyperparameterTuningJobs()...)
				nextPageToken = page.GetNextPageToken()
				if nextPageToken == "" {
					break
				}
	...
	}
	{
		...
		t.Run("page size zero", func(t *testing.T) {
			...
			for {
				...
				req.SetPageSize(0)
				req.SetPageToken(nextPageToken)
				page, err := fx.Service().ListModelDeploymentMonitoringJobs(fx.Context(), req)
				assert.NilError(t, err)
				msgs = append(msgs, page.GetModelDeploymentMonitoringJobs()...)
				nextPageToken = page.GetNextPageToken()
				if nextPageToken == "" {
					break
				}
	...
	}
	{
		...
		t.Run("page size zero", func(t *testing.T) {
			...
			for {
				...
				req.SetPageSize(0)
				req.SetPageToken(nextPageToken)
				page, err := fx.Service().ListNasJobs(fx.Context(), req)
				assert.NilError(t, err)
				msgs = append(msgs, page.GetNasJobs()...)
				nextPageToken = page.GetNextPageToken()
				if nextPageToken == "" {
					break
				}
	...
	}
	{
		...
		t.Run("page size zero", func(t *testing.T) {
			...
			for {
				...
				req.SetPageSize(0)
				req.SetPageToken(nextPageToken)
				page, err := fx.Service().ListNasTrialDetails(fx.Context(), req)
				assert.NilError(t, err)
				msgs = append(msgs, page.GetNasTrialDetails()...)
				nextPageToken = page.GetNextPageToken()
				if nextPageToken == "" {
					break
				}
